...
public class Add6RoomsCreationPage extends AbstractBasePage{
   ...
   */
     ...
     */
     ...
     entergdsCode(e.getCellData("Sheet1","gdsCode",2));
     clickOnBigsizeBed();
     try {
		uploadImage();
	} catch (Exception e1) {
     ...
     entergdsCode(e.getCellData("Sheet1","gdsCode",3));
     clickOnMarvelousBed();
     uploadImage();
     TestBase.implict(4);
     enterExtraAdultPerRoomCharge("100");
     ...
     entergdsCode(e.getCellData("Sheet1","gdsCode",4));
     clickOnBigsizeBed();
     uploadImage();
     ...
     entergdsCode(e.getCellData("Sheet1","gdsCode",5));
     clickOnDoubleBed();
     uploadImage();
     enterExtraAdultPerRoomCharge("100");
     enterExtraChildPerRoomCharge("30");
     ...
     entergdsCode(e.getCellData("Sheet1","gdsCode",6));
     clickOnExquisiteBed();
     uploadImage();
     enterExtraAdultPerRoomCharge("100");
     ...
     entergdsCode(e.getCellData("Sheet1","gdsCode",7));
     TestBase.implict(3);
     clickOnExquisiteBed();
     uploadImage();
     TestBase.implict(3);
