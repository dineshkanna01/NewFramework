...
public class RatePlanPage extends AbstractBasePage {
	...
	public RatePlanPage inputFields_tc01() {
		name.sendKeys(ExcelData.getCellData("RatePlanPageData", "Name_TC01", 2));
		Helper.implict(1);
		ratePlanCode.sendKeys(ExcelData.getCellData("RatePlanPageData", "RateTypeCode_TC01", 2));
		Helper.implict(1);
	...
	public RatePlanPage inputFields_tc02() {
		...
		firstCheckInDate.sendKeys(strDate);
		Helper.implict(1);
		roomTextBox.sendKeys(ExcelData.getCellData("RatePlanPageData", "RoomNameTextbox", 2));
		return null;
	}
	/*
	...
	public RatePlanPage inputFields_tc05() {
		...
		dropdown.selectByVisibleText(ExcelData.getCellData("RatePlanCategoriesData", "CategoryName", 2));
		shortDescription.sendKeys(ExcelData.getCellData("RatePlanPageData", "ShortDescription_TC01", 2));
		Helper.implict(1);
		DateFormat dateFormat = new SimpleDateFormat("MM/dd/YY");
		Date date = new Date();
	...
	public boolean verifyRateName() {
		...
		String ExcelrateName = ExcelData.getCellData("RatePlanPageData", "Name_TC01", 2);
