...
public CancelWebBookingFromMobilePages webBEReservation()  {
		...
		arrivalDate.sendKeys(ExcelData.getCellData("MBTC7", "ArrivalDate", 2));
		Helper.implict(8);
		departureDate.clear();
		departureDate.sendKeys(ExcelData.getCellData("MBTC7", "DepartureDate", 2));
...
public CancelWebBookingFromMobilePages cancelinMobWebBEReservation()  {
	...
	Helper.sleep(5000);
	//Helper.eleXpath("//input[@id='confirmation_code']", ExcelData.getCellData("LoginPageData", "WebConfirmCode", 2));
...
// * 
// */
//public boolean displayConfirmationCode() {
...
public AboutThePropertyPages getConfirmationNo() {
	...
	ExcelData.write_CellData("LoginPageData",1,18,b);
	return null;
}
/*
...
public AboutThePropertyPages getConfirmationMailId() {
	...
	ExcelData.write_CellData("LoginPageData",1,17,b);
	return null;
}
}
